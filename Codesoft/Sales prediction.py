...
# Create pairplot with regression line equations and correlation coefficients
...
sns.pairplot(data, x_vars=['TV', 'Radio', 'Newspaper'], y_vars='Sales', height=5, aspect=0.7, kind='reg', hue='Sales')
...
plt.scatter(y_test, y_pred, c='blue', alpha=0.7, label='Actual vs Predicted')
